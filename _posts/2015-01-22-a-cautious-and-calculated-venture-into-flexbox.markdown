...
{% include image name="austin-full.png" caption="A mockup of the design I had to build (desktop)" %}
...
{% include image name="austin-mobile.png" caption="Mobile view of the layout (before Flexbox)" %}
